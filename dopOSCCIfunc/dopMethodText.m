...
% Edits:
%   2019-09-10 minor tweak to wording
...
try
    ...
    inputs.defaults = struct(...
        ...
        'correct_replace','empty',...'linspace'; %,...'mean',... % 'median'
    ...
    if okay
        ...
        if okay
            if isempty(dop.tmp.steps) && isfield(dop,'step')
                dop.tmp.steps = fieldnames(dop.step);
                            ...
                            switch dop.tmp.heart_cycle_type
                                ...
                                case 'linear'
                                    dop.tmp.method_line = sprintf(['%s',...
                                        ...
                                        dop.tmp.method_line);
                                otherwise
                                    fprintf('!!!!Nothing specified... for heart cycle type\n');
                            end
                        case 'dopActCorrect'
                            %
                            ...
                            switch dop.tmp.act_separation_index
                                case 'iqr'
                                    dop.tmp.method_line = strrep(dop.tmp.method_line,...
                                        ...
                                        ' times the individual inter-quartile range, '],...
                                        dop.tmp.act_separation));
