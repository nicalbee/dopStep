function out = isTX(filename)
% dopOSCCI Mark II:isTX ~ 13-8-2010 (last edit)
%
% determines whether filename has a .TX extention - case insensitive.
% returns 1 or 0.
%
% answer=isTX(filename)
%
