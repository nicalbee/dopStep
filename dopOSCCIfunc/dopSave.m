...
%                                                 dop.tmp.p);
        ...
        if dop.tmp.gui
            ...
            msg = sprintf(['''%s'' function run successfully - data saved to:',...
                '\n\tFile = %s',...
                '\n\tDirectory = %s',...
                '\n\nAnd the following settings:',...
                '\n\tSummary: ',dopVarType(dop.tmp.summary),...
                '\n\tChannels: ',dopVarType(dop.tmp.channels),...
                '\n\tPeriods: ',dopVarType(dop.tmp.periods),...
                '\n\tEpochs: ',dopVarType(dop.tmp.epochs),...
                '\n\tVariables: ',dopVarType(dop.tmp.variables)],...
                mfilename,strrep(dop.save.save_file,'.mat','.dat'),dop.tmp.save_dir,...
                dop.tmp.summary{:},dop.tmp.channels{:},dop.tmp.periods{:},...
                dop.tmp.epochs{:},dop.tmp.variables{:});
            if ~okay
