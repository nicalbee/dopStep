function out=isEXP(filename)
% dopOSCCI Mark II:isEXP ~ 10-Jan-2011 (last edit)
%
% determines whether filename has a .EXP extention - case insensitive.
% returns 1 or 0.
%
% answer=isEXP(filename)
%
