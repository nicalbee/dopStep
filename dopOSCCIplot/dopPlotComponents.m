...
% 28-Aug-2016 NAB removed 'save' button if 'plot_save' variable set to 1
...
fig.close.h = uicontrol('parent',fig.h,'units','normalized',...
        ...
        %% save button
      save_button = 1;
      if ~isempty(varargin) && sum(strcmp(varargin,'plot_save')) && varargin{find(strcmp(varargin,'plot_save'))+1}
          save_button = 0;
      end
      if save_button
