        ...
        switch dop.step.next.name
            ...
            case 'timing'
                ...
                dop.step.next.tag = {'info','lower_text','upper_text',...
                    'epoch_text','epoch_lower','epoch_upper',...
                    'base_text','base_lower','base_upper',...
                    'poi_text','poi_lower','poi_upper'};
                dop.step.next.position = [dop.step.next.info_position;
                                 .35 .6 .2 .1; .6 .6 .2 .1;...
                    .1 .55 .2 .1; .35 .55 .2 .1; .6 .55 .2 .1;...
                    .1 .425 .2 .1; .35 .425 .2 .1; .6 .425 .2 .1;...
                    .1 .3 .2 .1; .35 .3 .2 .1; .6 .3 .2 .1];
                dop.step.next.HorizontalAlignment = {'left','center','center',...
