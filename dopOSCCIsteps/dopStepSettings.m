            ...
            case 'epoch'
              ...
              case 'screen'
                ...
                dop.step.next.string = {'Epoch Screening:',...
                    ...
                    'Activation:','type lower number','type upper number',...
                    ['Activation separation refers to the left minus right ',...
                    'difference. We assume that the differences we are ',...
                    'interested are below 10% change relative to baseline. ',...
                    'This options allows you to include epochs with separations ',...
                    'that are likely due to error. You can also specify the ',...
