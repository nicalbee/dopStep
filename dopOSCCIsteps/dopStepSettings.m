...
try
    ...
    dop.step.steps = ...
        {'welcome','data_file','channels','task_name','definition'};
    %% movement
        ...
        switch dop.step.next.name
            ...
            case 'channels'
                ...
                dop.step.next.tag = {'info','left_text','left_channel',...
                    ...
                    'event_text','event_channel'};
                dop.step.next.position = [dop.step.next.info_position; ...
                    .2 .7 .1 .05; .3 .65 .3 .1; ...
                    .2 .55 .1 .05; .3 .5 .3 .1; ...
                    .2 .4 .1 .05; .3 .35 .3 .1];
                dop.step.next.HorizontalAlignment = {'left','center','center','center','center','center','center'};
