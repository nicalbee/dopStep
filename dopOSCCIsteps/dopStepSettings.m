...
%% > welcome:
            ...
            case 'events'
                dop.step.next.style = {'text','text','edit','edit','text','edit','edit'};
                ...
                dop.step.next.tag = {'title','info','event_height_text','event_height',...
                    'event_sep_info','event_sep_text','event_sep'};
                dop.step.next.position = [dop.step.next.title_position;...
                    dop.step.next.info_position;
                ...
                dop.step.next.Enable = {[],[],'off','on','on','off','on'};
            ...
            case 'norm'
                ...
                dop.step.next.tag = {'title','info','method_text','method_radio',...
