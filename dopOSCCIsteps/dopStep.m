...
try
    ...
    dop.step.action.tooltip = struct(...
        ...
        'save','to save the summary statistics to a text file',...
...
%     dop.tmp.last_action_num = dopStepLastActionButton(dop);
    ...
    dop.tmp.n_extra = dop.step.action.n-dop.tmp.last_action_num;
    dop.tmp.x_left = .88;
    dop.tmp.y_top = .75;
    dop.tmp.y_bot = .15;
    dop.tmp.y_space = (dop.tmp.y_top-dop.tmp.y_bot)/dop.tmp.n_extra;
    dop.step.action.position(dop.tmp.last_action_num+1:end,:) = ...
