...
% 14-Nov-2016 NAB added dop.save.summary check when saving
try
    ...
    switch get(obj,'tag')
        ...
        case 'save'
            ...
            if isfield(dop.save,'save_dir') && ~isempty(dop.save.save_dir)
                if ~isfield(dop.save,'summary')
                    [dop,okay,msg] = dopSave(dop,...
                        'save_dir',dop.save.save_dir,...
                        'gui');
                else
                    [dop,okay,msg] = dopSave(dop,...
                        'save_dir',dop.save.save_dir,...
                        'summary',dop.save.summary,...
                        'channels',dop.save.channels,...
                        'periods',dop.save.periods,...
                        'epochs',dop.save.epochs,...
                        'variables',dop.save.variables,...
                        'gui');
                end
            else
                if ~isfield(dop.save,'summary')
